...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2024 at 04:45 AM
...
CREATE TABLE `candidates` (
  ...
  `status` enum('interviewed','hired','rejected') DEFAULT NULL
...
(35, 'Rice', 180, 1600.00, 'Bags of rice of weight 25kg');
...
INSERT INTO `sales` (`id`, `product_id`, `quantity`, `total_price`, `date`, `price`) VALUES
(32, 35, 20, 32000.00, '2024-08-08 22:19:58', 1600.00);
...
INSERT INTO `suppliers` (`id`, `company_name`, `province`, `city`, `phone_number`) VALUES
(10, 'TORI', 'Gandaki', 'Pokhara', '9867669502'),
(11, 'DHWAJ', 'Gandaki', 'Pokhara', '9867669502');
